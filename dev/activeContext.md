...
updated: 2026-09-20T07:10:00+01:00
STATE: IDLE
...
## position
M1-M14, M16-M22, M25 closed (M12 superseded by M13; M22 on 2026-09-19 with S6-S8 withdrawn on bounds, D110-D118). Open in order: M23, M24, M26, M15; plans in `dev/plans/`.
## evidence
...
## blocked/carried
- Cached `.jls` parts: only 5mm_n1, 10mm_n1,2,4 (`~/.cache/xcal_mem_probe/`) and `~/.cache/xcal_m22/hb10_n8` are at the current format 2 (D113); anything else must be regenerated with `mem_probe.jl part`, and M23-S1 replaces `.jls` altogether.
