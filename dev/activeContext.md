...
updated: 2026-09-20T06:50:00+01:00
STATE: IDLE
...
## blocked/carried
- Part format 2 since S4 (D113): 10 mm n=2,4 parts regenerated; 5 mm n>1, 4 mm, `ghost_n*` and `bfs5h_n*` parts are format 1 (5mm_n1, 10mm_n1,2,4 and `~/.cache/xcal_m22/hb10_n8` are format 2) and must be regenerated (`mem_probe.jl part`) before S6/S8 timing.
