...
STATE: PLANNING
STEP: flat-mesh result (D177) awaiting the user
HEAD: 49c1ff23
...
## position
M28 S1-S4, S7 landed (in-house containers, bitwise, runtime −11-13%). Access-side cures refuted (D172-D176); flat top-level columns compile 25-35% below the AoS base (D177, experiment, not landed).
