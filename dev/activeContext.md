...
updated: 2026-09-23T23:00:00+01:00
STATE: BUILDING
STEP: P1-M31-S7 type tags as one-element vectors (user request, D181)
HEAD: bdfc8606
...
resume: finish S7 per plan p1-m31 row (Mesh_0_types, Distribute_6_format placeholders, _rebuild_mesh_float), gate it, land; then S6
...
- Order: P1-M31 S7 (user request), S6 (discretise column reads), then P1-M28-S6 close, then M29, then M30 (D159). Commit and push each step.

## position
Flat mesh layout landed (P1-M31-S5, D180); S1 column-read diff stacks on it for S6.
