...
updated: 2026-09-20T04:00:00+01:00
STATE: BUILDING
STEP: P1-M22-S6 sync_begin!/sync_end! overlap at two body points
HEAD: 9532c564
...
## blocked/carried
- Part format 2 since S4 (D113): 10 mm n=2,4 parts regenerated; 5 mm, 4 mm, `ghost_n*` and `bfs5h_n*` parts are format 1 and must be regenerated (`mem_probe.jl part`) before S6/S8 timing.
