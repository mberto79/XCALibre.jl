...
STATE: IDLE
STEP: P1-M23-S2 `distribute` from a decomposed OpenFOAM case (next; S1 landed D123)
HEAD: 09cb77a4
...
resume: start P1-M23-S2 per the plan: first settle the open question (decomposePar the 10 mm BFS with OpenFOAM 12 and 2512, check `cellProcAddressing`), then S3-S5, M24, M26, M15
## binding
