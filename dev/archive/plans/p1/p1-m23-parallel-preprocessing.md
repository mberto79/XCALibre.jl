...
- SETTLED (D124): OpenFOAM 12 and v2512 both write `cellProcAddressing` in `processor<r>/constant/polyMesh`.
- SETTLED (D127): the conda PETSc carries both ParMETIS and PT-Scotch; stock `PETSc_jll` carries neither.
