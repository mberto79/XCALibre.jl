...
- [x] **P1-M24-S3** DELIVERED (D132): the guide documents checkpointing and restart, and `write_interval` semantics for it - mechanism: documentation - verdict: docs build green.
