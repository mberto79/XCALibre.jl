...
- [x] **P1-M18-S1** LANDED d91c67b8 (docs build 0 errors, `git diff main --stat` free of docs/1) - remove `docs/1/*` from the branch; move `PLAN_REVIEW.md` and `distributed_plan_detailed.md` to `archive/dev_distributed/`, `SCALING_SUMMARY.md` to `dev/telemetry/scaling_summary.md` (its own image and csv links become relative to `dev/telemetry/`; the only other citations are in `AUDIT.md`, checked 2026-09-19), and at milestone close `AUDIT.md` to `dev/archive/reviews/p1/audit-2026-09-18.md` with every plan citation updated (D77) - mechanism: no result file or working document lives at the repository root - cost: none - verdict: `git diff main --stat` lists no `docs/1`, docs build green.
