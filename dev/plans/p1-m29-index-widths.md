...
- [ ] P1-M29-S1 global IDs Int64: `local_to_global`, `orig_cells`, `orig_faces` get their own type parameter, decoupled from the mesh's `VI`; test with synthetic offsets above `typemax(Int32)`. Blast radius: distributed setup, writer, restart. Bar: strict class, `gate.jl`, `test_restart.jl`.
