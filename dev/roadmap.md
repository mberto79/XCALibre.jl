...
- [ ] P1 - release polish: make the module stock-installable, environment-variable free, rank-uniform by construction, scaling-attributed, gated and documented, then structurally ready to scale (D72), then moving fewer bytes per iteration on every backend (M28-M30, D159) | `dev/phaseRoadmap.md`
