function adjust_boundary!(b_cpu, BC::Slip, phif::FaceScalarField, phi, boundaries, boundary_cellsID, time,  backend, workgroup)
...
function adjust_boundary!(b_cpu, BC::Slip, psif::FaceVectorField, psi::VectorField, boundaries, boundary_cellsID, time, backend, workgroup)
    (; x, y, z) = psif
