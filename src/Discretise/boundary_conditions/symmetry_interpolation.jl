function adjust_boundary!(b_cpu, BC::Symmetry, phif::FaceScalarField, phi, boundaries, boundary_cellsID, time, backend, workgroup)
...
function adjust_boundary!(b_cpu, BC::Symmetry, psif::FaceVectorField, psi::VectorField, boundaries, boundary_cellsID, time, backend, workgroup)
    (; x, y, z) = psif
