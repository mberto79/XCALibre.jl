...
"""
struct Physics{T,F,SO,M,Tu,E,D,BI,ReferenceFrames}
    time::T
    fluid::F
    solid::SO
    momentum::M 
...
"""
Physics(; time, fluid=nothing, solid=nothing, turbulence=nothing, energy, domain, reference_frames=nothing) = begin
